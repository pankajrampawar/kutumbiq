...
export const TiffinHolder = ({
    ...
    // Dynamic beams based on screen width
    const beams = [
        {
            initialX: 10,
            translateX: 10,
        ...
        // Additional beams for smaller screens
        ...(screenWidth < 768 ? [
            {
                initialX: 200,
                translateX: 200,
    ...
    return (
        <div
            ref={parentRef}
            className={cn(
                "h-[85vh] md:h-[40rem] bg-white relative flex items-center w-full justify-center overflow-hidden",
                className
            )}>
            {beams.map((beam) => (
                <CollisionMechanism
